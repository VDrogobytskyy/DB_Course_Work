...
public:
    ...
    QLabel *label_12;
    QLineEdit *add_w_name_lineEdit;
    QHBoxLayout *horizontalLayout_19;
    QLabel *label_13;
    QLineEdit *add_w_surname_lineEdit;
    QHBoxLayout *horizontalLayout_18;
    QLabel *label_14;
    QLineEdit *add_w_aftername_lineEdit;
    QHBoxLayout *horizontalLayout_17;
    QLabel *label_15;
    QLineEdit *add_w_position_lineEdit;
    QHBoxLayout *horizontalLayout_16;
    QLabel *label_16;
    QLineEdit *add_w_work_type_lineEdit;
    QHBoxLayout *horizontalLayout_31;
    QLabel *label_34;
    QLineEdit *add_wt_cost_lineEdit;
    QHBoxLayout *horizontalLayout_15;
    QLabel *label_17;
    QComboBox *add_worker_detail_comboBox;
    QPushButton *create_worker_pushButton;
    QHBoxLayout *horizontalLayout_21;
    QLabel *label_18;
    QComboBox *dismiss_worker_combobox;
    QPushButton *dismis_worker_pushButton;
    ...
    QLabel *label_21;
    QLineEdit *add_detail_name_lineEdit;
    QHBoxLayout *horizontalLayout_27;
    QLabel *label_22;
    QLineEdit *add_detail_cost_lineEdit;
    QHBoxLayout *horizontalLayout_26;
    QLabel *label_23;
    QLineEdit *add_detail_remaining_lineEdit;
    QPushButton *add_detail_pushButton;
    QLabel *label_24;
    QHBoxLayout *horizontalLayout_25;
    QLabel *label_25;
    QComboBox *choose_detail_to_change_comboBox;
    QHBoxLayout *horizontalLayout_24;
    QLabel *label_26;
    QLineEdit *new_detail_name_lineEdit;
    QHBoxLayout *horizontalLayout_23;
    QLabel *label_28;
    QLineEdit *new_detail_cost_lineEdit;
    QHBoxLayout *horizontalLayout_22;
    QLabel *label_27;
    QLineEdit *new_detail_remaining_lineEdit;
    QPushButton *change_detail_value_pushButton;
    ...
    QLabel *label_31;
    QDateEdit *from_report_dateEdit;
...
"}"));
        ...
        groupBox_4->setGeometry(QRect(20, 160, 311, 451));
        layoutWidget6 = new QWidget(groupBox_4);
        layoutWidget6->setObjectName("layoutWidget6");
        layoutWidget6->setGeometry(QRect(20, 30, 271, 401));
        ...
        add_w_name_lineEdit = new QLineEdit(layoutWidget6);
        add_w_name_lineEdit->setObjectName("add_w_name_lineEdit");

        horizontalLayout_20->addWidget(add_w_name_lineEdit);
        ...
        add_w_surname_lineEdit = new QLineEdit(layoutWidget6);
        add_w_surname_lineEdit->setObjectName("add_w_surname_lineEdit");

        horizontalLayout_19->addWidget(add_w_surname_lineEdit);
        ...
        add_w_aftername_lineEdit = new QLineEdit(layoutWidget6);
        add_w_aftername_lineEdit->setObjectName("add_w_aftername_lineEdit");

        horizontalLayout_18->addWidget(add_w_aftername_lineEdit);
        ...
        add_w_position_lineEdit = new QLineEdit(layoutWidget6);
        add_w_position_lineEdit->setObjectName("add_w_position_lineEdit");

        horizontalLayout_17->addWidget(add_w_position_lineEdit);
        ...
        add_w_work_type_lineEdit = new QLineEdit(layoutWidget6);
        add_w_work_type_lineEdit->setObjectName("add_w_work_type_lineEdit");

        horizontalLayout_16->addWidget(add_w_work_type_lineEdit);
        ...
        add_wt_cost_lineEdit = new QLineEdit(layoutWidget6);
        add_wt_cost_lineEdit->setObjectName("add_wt_cost_lineEdit");

        horizontalLayout_31->addWidget(add_wt_cost_lineEdit);
        ...
        add_worker_detail_comboBox = new QComboBox(layoutWidget6);
        add_worker_detail_comboBox->setObjectName("add_worker_detail_comboBox");

        horizontalLayout_15->addWidget(add_worker_detail_comboBox);


        verticalLayout_9->addLayout(horizontalLayout_15);

        create_worker_pushButton = new QPushButton(layoutWidget6);
        create_worker_pushButton->setObjectName("create_worker_pushButton");

        verticalLayout_9->addWidget(create_worker_pushButton);
        ...
        dismiss_worker_combobox = new QComboBox(layoutWidget6);
        dismiss_worker_combobox->setObjectName("dismiss_worker_combobox");

        horizontalLayout_21->addWidget(dismiss_worker_combobox);


        verticalLayout_9->addLayout(horizontalLayout_21);

        dismis_worker_pushButton = new QPushButton(layoutWidget6);
        dismis_worker_pushButton->setObjectName("dismis_worker_pushButton");

        verticalLayout_9->addWidget(dismis_worker_pushButton);

        groupBox_5 = new QGroupBox(admin_page_2);
        groupBox_5->setObjectName("groupBox_5");
        groupBox_5->setGeometry(QRect(350, 160, 311, 451));
        layoutWidget7 = new QWidget(groupBox_5);
        layoutWidget7->setObjectName("layoutWidget7");
        layoutWidget7->setGeometry(QRect(20, 40, 271, 383));
        ...
        add_detail_name_lineEdit = new QLineEdit(layoutWidget7);
        add_detail_name_lineEdit->setObjectName("add_detail_name_lineEdit");

        horizontalLayout_28->addWidget(add_detail_name_lineEdit);
        ...
        add_detail_cost_lineEdit = new QLineEdit(layoutWidget7);
        add_detail_cost_lineEdit->setObjectName("add_detail_cost_lineEdit");

        horizontalLayout_27->addWidget(add_detail_cost_lineEdit);
        ...
        add_detail_remaining_lineEdit = new QLineEdit(layoutWidget7);
        add_detail_remaining_lineEdit->setObjectName("add_detail_remaining_lineEdit");

        horizontalLayout_26->addWidget(add_detail_remaining_lineEdit);


        verticalLayout_10->addLayout(horizontalLayout_26);

        add_detail_pushButton = new QPushButton(layoutWidget7);
        add_detail_pushButton->setObjectName("add_detail_pushButton");

        verticalLayout_10->addWidget(add_detail_pushButton);
        ...
        choose_detail_to_change_comboBox = new QComboBox(layoutWidget7);
        choose_detail_to_change_comboBox->setObjectName("choose_detail_to_change_comboBox");

        horizontalLayout_25->addWidget(choose_detail_to_change_comboBox);
        ...
        new_detail_name_lineEdit = new QLineEdit(layoutWidget7);
        new_detail_name_lineEdit->setObjectName("new_detail_name_lineEdit");

        horizontalLayout_24->addWidget(new_detail_name_lineEdit);
        ...
        new_detail_cost_lineEdit = new QLineEdit(layoutWidget7);
        new_detail_cost_lineEdit->setObjectName("new_detail_cost_lineEdit");

        horizontalLayout_23->addWidget(new_detail_cost_lineEdit);
        ...
        new_detail_remaining_lineEdit = new QLineEdit(layoutWidget7);
        new_detail_remaining_lineEdit->setObjectName("new_detail_remaining_lineEdit");

        horizontalLayout_22->addWidget(new_detail_remaining_lineEdit);


        verticalLayout_10->addLayout(horizontalLayout_22);

        change_detail_value_pushButton = new QPushButton(layoutWidget7);
        change_detail_value_pushButton->setObjectName("change_detail_value_pushButton");

        verticalLayout_10->addWidget(change_detail_value_pushButton);
        ...
        create_pdf_pushButton = new QPushButton(layoutWidget8);
        create_pdf_pushButton->setObjectName("create_pdf_pushButton");

        verticalLayout_11->addWidget(create_pdf_pushButton);
    ...
    void retranslateUi(QMainWindow *Main_Window)
    {
        ...
        label_34->setText(QCoreApplication::translate("Main_Window", "Work cost", nullptr));
        label_17->setText(QCoreApplication::translate("Main_Window", "Detail to work with", nullptr));
        create_worker_pushButton->setText(QCoreApplication::translate("Main_Window", "Create Worker", nullptr));
        label_18->setText(QCoreApplication::translate("Main_Window", "To Dismiss", nullptr));
        dismis_worker_pushButton->setText(QCoreApplication::translate("Main_Window", "Dismiss", nullptr));
        ...
        add_detail_pushButton->setText(QCoreApplication::translate("Main_Window", "Add detail", nullptr));
        ...
        change_detail_value_pushButton->setText(QCoreApplication::translate("Main_Window", "Make change", nullptr));
        ...
        from_report_dateEdit->setDisplayFormat(QCoreApplication::translate("Main_Window", "yyyy.MM.dd", nullptr));
